                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ open: false, selected: '{{ old('bairro_id') ?? '' }}', selectedName: '{{ old('bairro_name') ?? '' }}' }" 
                        ...
                        <ul x-show="open" @click.outside="open = false"
                            class="absolute w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-xl max-h-60 overflow-auto z-[9999]">
                    ...
                    {{-- NOME CIENTÍFICO (Igual ao Admin) --}}
                    <div x-data="{
