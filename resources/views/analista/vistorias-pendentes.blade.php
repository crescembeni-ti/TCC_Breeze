                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    @elseif($vistoria->contact->foto_path)
                                        <button @click="photoUrl = '{{ Storage::url($vistoria->contact->foto_path) }}'; showPhoto = true; currentPhotos = [];" class="flex items-center gap-1 text-[#358054] hover:underline font-bold">
