                ...
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <select id="topico" name="topico" required
                                ...
                                @foreach ($topicos as $topico)
                                    <option value="{{ $topico->nome }}" {{ old('topico') == $topico->nome ? 'selected' : '' }}>
                                        {{ $topico->nome }}
                                    </option>
                                @endforeach
                            </select>
                            @error('topico') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="bairro" name="bairro" required
                                ...
                                @foreach ($bairros as $bairro)
                                    <option value="{{ $bairro->nome }}" {{ old('bairro') == $bairro->nome ? 'selected' : '' }}>
                                        {{ $bairro->nome }}
                                    </option>
                                @endforeach
                            </select>
                            @error('bairro') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('rua') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                        </div>
